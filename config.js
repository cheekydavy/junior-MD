...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '05_17_H_E_R_M_I_T_V5ZCB45',
    ...
    BOT_NAME: process.env.BOT_NAME || 'JUNIOR',
    ...
    BOT_INFO: process.env.BOT_INFO || 'JUNIOR;MBUVI;254746440595;https://telegra.ph/file/a7ca8d4777fa8ad977795.jpg,
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'JUNIOR;MBUVI;https://telegra.ph/file/a7ca8d4777fa8ad977795.jpg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'JUNIOR;MBUVI' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '254746440595,0',
       DEBUG: DEBUG
};
